...
import { MoreHorizontal, Pencil, Trash2, Check, X, Clock } from "lucide-react";
...
import { useDMReactions } from "@/hooks/dm";
...
export function DMMessageItem({
    ...
    const { toggleReaction } = useDMReactions();
        ...
        <div className="flex gap-3 py-3 px-4 hover:bg-muted/30 group transition-colors">
            ...
            <div className="flex-1 min-w-0">
                ...
                {message.attachments && message.attachments.length > 0 && (
                    <ImageGallery attachments={message.attachments as any} />
                )}
